...
int main() {
    embaralharPalavras();//Embaralha as palavras.
    inicializarMatriz();//Inicializa a matriz com espaços vazios.
    colocarPalavras();//Coloca as palavras na matriz.
    preencherMatriz();//Preenche os espaços vazios com letras aleatórias.
    imprimirMatriz();//Imprime a matriz final.
    return 0;
}